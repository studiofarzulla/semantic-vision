...
The author acknowledges Claude (Anthropic) for assistance with analytical framework development, tensor decomposition analysis, and technical writing. The author thanks the Visual Genome project for providing human affordance annotations for baseline comparison. All errors, omissions, and interpretive limitations remain the author's responsibility.
